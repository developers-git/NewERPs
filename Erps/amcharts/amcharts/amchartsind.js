...
if (a) {
  ...
  switch (this.position) {
    case 'bottom':
      c = 0;
      e = k;
      g ? (d = 0, f = l)  : (d = l, f = l + 1000);
      break;
    case 'top':
      c = 0;
      e = k;
      g ? (d = 0, f = l)  : (d = - 1000, f = 0);
      break;
    case 'left':
      d = 0;
      f = l;
      g ? (c = 0, e = k)  : (c = - 1000, e = 0);
      break;
    case 'right':
      d = 0,
      f = l,
      g ? (c = 0, e = k)  : (c = k, e = k + 1000)
  }
...
if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || - Infinity == this.max) e = !0;
  ...
  this.parseDatesDraw();
    ...
    if (t == this.baseValue && 'radar' != a.type) {
      ...
      K = this.width,
      H = this.height;
      'H' == this.orientation ? 0 <= f && f <= K + 1 && (D = [
        f,
        f,
        f + k
      ], C = [
...
'H' == a.orientation ? (e = d.line(p, [
  ...
  0,
  0
], e, h, c), this.axisWidth = a.width, 'bottom' == a.position ? (k = c / 2 + f + n + m - 1, c = l)  : (k = - c / 2 - f + m + k, c = g + l))  : (this.axisWidth = a.height, 'right' == a.position ? (e = d.line(p, [
  0,
  0,
  - g
], [
  ...
  n,
  n - k
], e, h, c), k = m + k, c = c / 2 + f + g + q + l - 1)  : (e = d.line(p, [
  0,
  0
], [
  0,
...
if ('H' == Pa) {
  if (0 <= b && b <= Aa + 1 && (0 < B && 0 < z && b + l <= Aa + 1 && (fa = d.line(y, [
    b + l,
    b + l
  ], [
    0,
    B
  ], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [
    b,
    b + wa,
    b + wa
  ], [
  ...
  w = b - Qa / 2 + 2;
  1 == ia && 0 < O && !g && !m && (e = d.fitToBounds(b, 0, X), da = d.fitToBounds(da, 0, X), V = e - da, Da = d.polygon(y, [
    0,
    a.width,
    a.width,
    0
    ...
    V,
    V
  ], P, O), Da.translate(wa, e - V + ma), x.push(Da));
  w += r / 2;
...
if (!this.hideCredits) {
  ...
  if (c != a || !0 === this.inIframe()) {
    ...
    k = 'JavaScript charts',
    l = 'Analysis by industry';
    'ammap' == this.product && (g = a + '/javascript-maps/', k = 'Interactive JavaScript maps', l = 'Analysis by industry');
...
switch (g) {
case 'line':
if (isNaN(W)) y || (this.drawLineGraph(x, u, T, U), x = [
], u = [
], T = [
], U = [
]);
  ...
  if (Math.abs(E -
  jb) >= lb || Math.abs(F - kb) >= lb) x.push(E),
  u.push(F),
  jb = E,
  kb = F;
  xa = E;
  ...
  this.dashLengthSwitched = w.dashLength;
  w.gap && (this.drawLineGraph(x, u, T, U), x = [
  ], u = [
  ], T = [
  ], U = [
  ])
...
break;
case 'smoothedLine':
if (isNaN(W)) y || (this.drawSmoothedGraph(x, u, T, U), x = [
], u = [
], T = [
], U = [
]);
  ...
  la = F;
  !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M));
  void 0 == w.lineColor && void 0 == w.fillColors && isNaN(w.dashLength) || (this.drawSmoothedGraph(x, u, T, U), x = [
    E
  ], u = [
    F
  ], T = [
  ], U = [
  ], !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M)), this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors, this.dashLengthSwitched = w.dashLength);
  w.gap && (this.drawSmoothedGraph(x, u, T, U), x = [
  ], u = [
  ], T = [
  ], U = [
  ])
...
if (!isNaN(W)) {
  ...
  if (ua) {
    ...
    if (!I) {
      ...
      '3d' == O && (t ? (K = (this.end + 1 - L) * C - c - 1000 * this.depthCount, xa += H * Z, ka += H * Z, w.y += H * Z)  : (K = (C - c) * (L + 1) + 1000 * this.depthCount, Ea += P * Z, la += P * Z, w.y += P * Z));
...
if (!isNaN(ta) && !isNaN(W)) {
  ...
  if (t) {
    ...
    if (Q < q && 0 < J) {
      ...
      !isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Eb, [
        F,
        F
      ], Ca, X, da), cb = d.line(h, Fb, [
        F,
        F
      ], Ca, X, da));
      ba = E - N;
    ...
    if (S < n && 0 < J) {
      ...
      !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [
        E,
        E
      ], Gb, Ca, X, da), cb = d.line(h, [
        E,
        E
      ], Hb, Ca, X, da), d.setCN(a, Xa, this.bcn + 'line-high'), w.className && d.setCN(a, Xa, w.className, !0), d.setCN(a, cb, this.bcn + 'line-low'), w.className && d.setCN(a, cb, w.className, !0))
    }
  }
...
if ('serial' == e.type || 'gantt' == e.type) if ( - 0.5 > b || b > this.width || c < - g / 2 || c > this.height) p.remove(),
p = null;
...
if (p) {
p.size = g || 0;
if (e = this.bulletHitAreaSize) h = d.circle(h, e, '#FFFFFF', 0.001, 0),
h.translate(b, c),
a.hitBullet = h,
...
1, R, O, u), d.isModern ? a.translate(1, 1)  : a.translate(4, 4), f.push(a)), q = d.rect(h, C, A, q, v, r, p, aa, u))  : (t = [
], u = [
], 'H' != x ? (g = a - D, g > C - y && (g = C - y), g < y && (g = y), t = [
0,
g - y,
a - D,
g + y,
...
0,
C
]), 0 < O && (a = d.polygon(h, t, u, q, 0, r, R, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, u, q, v, r, p, aa));
this.bg = q;
f.push(q);
q.toFront();
...
c && (c.setAttr('opacity', a.opacity), a.set.rotate(a.rotation), c.translate( - a.width / 2, - a.height / 2, e), a.balloonText && c.mouseover(function () {
...
], f = 1; f < a.length; f++) for (var g = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.round(Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - g) / n, m = (m - k) / n, q = 0; q <= n; q++) {
...
t[r - 1],
t[r]
], e, h, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, k, l, m, !0));
return q
};
...
a && (a.addCodeCredits && b.appendChild(document.createTextNode('Analysis by industry ' + a.version)), c.appendChild(b), a.defs && (b = this.createSvgElement('defs'), c.appendChild(b), d.parseDefs(a.defs, b), this.defs = b))
}
}
})
}) (); (function () {
