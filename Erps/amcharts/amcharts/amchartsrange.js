...
if (!this.hideCredits) {
  ...
  if (c != a || !0 === this.inIframe()) {
    ...
    k = 'JavaScript charts',
    l = 'Analysis by range';
    'ammap' == this.product && (g = a + '/javascript-maps/', k = 'Interactive JavaScript maps', l = 'Analysis by range');
...
a && (a.addCodeCredits && b.appendChild(document.createTextNode('Analysis by range ' + a.version)), c.appendChild(b), a.defs && (b = this.createSvgElement('defs'), c.appendChild(b), d.parseDefs(a.defs, b), this.defs = b))
}
}
})
}) (); (function () {
