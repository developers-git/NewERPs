...
if (!this.hideCredits) {
  ...
  if (c != a || !0 === this.inIframe()) {
    ...
    k = 'JavaScript charts',
    l = 'Analysis by country';
    'ammap' == this.product && (g = a + '/javascript-maps/', k = 'Interactive JavaScript maps', l = 'Analysis by country');
...
a && (a.addCodeCredits && b.appendChild(document.createTextNode('Analysis by country ' + a.version)), c.appendChild(b), a.defs && (b = this.createSvgElement('defs'), c.appendChild(b), d.parseDefs(a.defs, b), this.defs = b))
}
}
})
}) (); (function () {
